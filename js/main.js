...
(function () {
  ...
  function makeMark(tagOptions) {
    ...
    label[k].style.top = tagOptions.location.y - parseInt(labelStyle.height, 10) + 'px';
    label[k].style.left = tagOptions.location.x - parseInt(labelStyle.width, 10) / 2 + 'px';
